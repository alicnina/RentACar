 ...
 */
            ...
            /**
            *  DisablePoliceRegister bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DisablePoliceRegister
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":disablePoliceRegister",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "disablePoliceRegister",
    ...
    public static class Factory{
        ...
        */
        public static DisablePoliceRegister parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DisablePoliceRegister object =
                new DisablePoliceRegister();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"disablePoliceRegister".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DisablePoliceRegister)com.alicnina.policeregistersimulator.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
