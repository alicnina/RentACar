...
public class InitializePoliceRegisterResponse implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://policeregistersimulator.alicnina.com",
			"initializePoliceRegisterResponse", "ns1");
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":initializePoliceRegisterResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "initializePoliceRegisterResponse", xmlWriter);
			}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
		...
		elementList.add(new javax.xml.namespace.QName("http://policeregistersimulator.alicnina.com", "code"));
		...
		elementList.add(new javax.xml.namespace.QName("http://policeregistersimulator.alicnina.com", "message"));
	...
	public static class Factory {
		...
		public static InitializePoliceRegisterResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			InitializePoliceRegisterResponse object = new InitializePoliceRegisterResponse();
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"initializePoliceRegisterResponse".equals(type)) {
							...
							return (InitializePoliceRegisterResponse) com.alicnina.policeregistersimulator.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
