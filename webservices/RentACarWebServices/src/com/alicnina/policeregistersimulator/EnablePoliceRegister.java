 ...
 */
            ...
            /**
            *  EnablePoliceRegister bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EnablePoliceRegister
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":enablePoliceRegister",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "enablePoliceRegister",
    ...
    public static class Factory{
        ...
        */
        public static EnablePoliceRegister parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnablePoliceRegister object =
                new EnablePoliceRegister();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"enablePoliceRegister".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EnablePoliceRegister)com.alicnina.policeregistersimulator.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
