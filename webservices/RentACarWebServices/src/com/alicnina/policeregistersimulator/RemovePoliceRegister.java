...
/**
 * RemovePoliceRegister bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class RemovePoliceRegister implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://policeregistersimulator.alicnina.com",
			"removePoliceRegister", "ns1");
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":removePoliceRegister", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "removePoliceRegister", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static RemovePoliceRegister parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			RemovePoliceRegister object = new RemovePoliceRegister();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"removePoliceRegister".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
							return (RemovePoliceRegister) com.alicnina.policeregistersimulator.ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
